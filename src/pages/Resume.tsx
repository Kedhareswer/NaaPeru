...
const Resume = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#1a1a1a]">
      ...
      <main className="relative z-10 flex items-center justify-center px-4 py-24 sm:py-32">
        {/* A4 Paper Container */}
        <div className="relative w-full max-w-[210mm] bg-[#f5f5f0] text-[#1a1a1a] shadow-2xl p-12" style={{ minHeight: '297mm' }}>
