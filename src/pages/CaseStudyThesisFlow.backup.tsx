...
export const CaseStudyThesisFlow = () => {
  ...
  const slides = [
    { id: 0, title: "Overview", subtitle: "ThesisFlow-AI" },
    { id: 1, title: "The Story", subtitle: "Why I Built This" },
    { id: 2, title: "The Problem", subtitle: "Research Workflow Problem" },
    { id: 3, title: "The Solution", subtitle: "AI-Powered Research Hub" },
    { id: 4, title: "Key Features", subtitle: "What Makes It Special" },
    { id: 5, title: "Architecture", subtitle: "Technical Architecture" },
    { id: 6, title: "Challenges", subtitle: "Challenges & Solutions" },
    { id: 7, title: "Results", subtitle: "The Results" },
    { id: 8, title: "Learnings", subtitle: "What I Learned" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20">
        ...
        <motion.section
          id="overview"
          className="case-study-slide container-portfolio mb-20 lg:ml-64 min-h-[90vh] flex items-center"
        ...
        {/* CTA */}
        <motion.section
          className="case-study-slide container-portfolio lg:ml-64 min-h-[90vh] flex items-center"
          variants={sectionVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false, amount: 0.4 }}
        ...
        <div className="fixed bottom-8 left-1/2 z-30 flex -translate-x-1/2 items-center gap-4">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border/40 bg-background/80 px-4 py-2 font-body text-xs font-semibold uppercase tracking-wider text-foreground/80 backdrop-blur-sm transition-colors disabled:cursor-not-allowed disabled:opacity-40 hover:border-primary hover:text-primary"
          >
            <ArrowLeft className="w-4 h-4" />
            Previous
          </button>
