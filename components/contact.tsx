...
import { Send, Mail, MapPin, Phone, ArrowRight, Sparkles, Calendar, ExternalLink } from "lucide-react"
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <motion.div variants={childVariants}>
                          <label htmlFor="name" className="block text-sm font-medium text-zinc-600 mb-1">Name</label>
                          <input
                            type="text"
                            id="name"
                            name="name"
                      ...
                      <motion.div variants={childVariants}>
                        <label htmlFor="subject" className="block text-sm font-medium text-zinc-600 mb-1">Subject</label>
                        <input
                          type="text"
                          id="subject"
                          name="subject"
                      ...
                      <motion.div variants={childVariants}>
                        <label htmlFor="message" className="block text-sm font-medium text-zinc-600 mb-1">Message</label>
                        <textarea
                          id="message"
                          name="message"
