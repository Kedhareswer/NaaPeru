...
import EyePreloader from "./animate-ui/base/eye-preloader"
...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    if (!showPreloader) {
      // Start the main loading timer after preloader
    ...
    <>
      <AnimatePresence>
        {showPreloader && (
          ...
          >
            <EyePreloader onComplete={() => setShowPreloader(false)} show={showPreloader} />
          </motion.div>
        )}
      </AnimatePresence>
      <AnimatePresence mode="wait">
        {!showPreloader && !isComplete && (
          <motion.div
