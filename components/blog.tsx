...
const blogPosts = [
  ...
  {
    title: "The Impact of AI on Modern Data Science",
    excerpt: "Discussing how artificial intelligence is transforming the field of data science and creating new opportunities.",
    date: "2024-01-10",
    platform: "Medium",
    link: "#",
    readTime: "4 min read",
